        ...
        <div className="transaction-history">
            <div className="stats">
                <div className="stat-card">
                    <h3>Total Revenue</h3>
                    <p>{stats.totalRevenue.toFixed(4)} ALGO</p>
                </div>
                <div className="stat-card">
                ...
                <div className="stat-card">
                    ...
                    <p>{stats.avgAmount.toFixed(4)} ALGO</p>
                </div>
            </div>
                ...
                <tbody>
                    {transactions.map((tx) => (
                        <tr key={tx.id || tx.txid}>
                            <td className="txid">{tx.txid?.slice(0, 8) || 'unknown'}...</td>
                            <td className="amount">{tx.amount} ALGO</td>
